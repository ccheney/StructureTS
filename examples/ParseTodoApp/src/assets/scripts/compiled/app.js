...
(function (StructureTS) {
    ...
    StructureTS.EventBroker = EventBroker;
})(StructureTS || (StructureTS = {}));
var codeBelt;
(function (codeBelt) {
    ...
    codeBelt.ListItemEvent = ListItemEvent;
})(codeBelt || (codeBelt = {}));
var StructureTS;
(function (StructureTS) {
    ...
    StructureTS.RequestEvent = RequestEvent;
})(StructureTS || (StructureTS = {}));
var StructureTS;
(function (StructureTS) {
...
(function (codeBelt) {
    ...
    var AppModel = (function (_super) {
        ...
        AppModel.prototype.onGetSuccess = function (item) {
            ...
            var listItemVO = new codeBelt.ListItemVO();
            listItemVO.id = item.id;
            listItemVO.content = item.get('content');
            listItemVO.isComplete = item.get('isComplete');

            this.dispatchEvent(new codeBelt.ListItemEvent(codeBelt.ListItemEvent.REMOVE_SUCCESS, false, false, listItemVO));
        };
        ...
        AppModel.prototype.onItemAddSuccess = function (item) {
            ...
            this.dispatchEvent(new codeBelt.ListItemEvent(codeBelt.ListItemEvent.ADD_SUCCESS, false, false, listItemVO));
        };
...
(function (codeBelt) {
    ...
    var TodoApp = (function (_super) {
        ...
        TodoApp.prototype.createChildren = function () {
            ...
            this._appModel = new codeBelt.AppModel();
        ...
        TodoApp.prototype.enable = function () {
            ...
            this._appModel.addEventListener(codeBelt.ListItemEvent.LIST_SUCCESS, this.onListRecieved, this);
            this._appModel.addEventListener(codeBelt.ListItemEvent.ADD_SUCCESS, this.onAddItemSuccess, this);
            this._appModel.addEventListener(codeBelt.ListItemEvent.REMOVE_SUCCESS, this.onRemoveItemSuccess, this);
        ...
        TodoApp.prototype.disable = function () {
            ...
            this._appModel.removeEventListener(codeBelt.ListItemEvent.LIST_SUCCESS, this.onListRecieved, this);
            this._appModel.removeEventListener(codeBelt.ListItemEvent.REMOVE_SUCCESS, this.onRemoveItemSuccess, this);

            _super.prototype.disable.call(this);
        };

        TodoApp.prototype.destroy = function () {
            _super.prototype.destroy.call(this);
