...
module codeBelt
{
    import Canvas = StructureTS.Canvas;
    import Stage = StructureTS.Stage;
    import Bitmap = StructureTS.Bitmap;
    import AssetLoader = StructureTS.AssetLoader;
    import ImageLoader = StructureTS.ImageLoader;
    import MathUtil = StructureTS.MathUtil;
    import LoaderEvent = StructureTS.LoaderEvent;
    /**
     *
     * @class BannerAd
     * @extends Stage
